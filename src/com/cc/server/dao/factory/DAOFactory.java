package com.cc.server.dao.factory;
...
import com.cc.server.dao.exception.DAOConfigurationException;
import com.cc.server.dao.impl.AssignmentDB;
import com.cc.server.dao.impl.EventCatDB;
...
import com.cc.server.dao.properites.DAOProperties;
 ...
 * 
 * <pre>
 * DAOFactory dbFactory = DAOFactory.getInstance(&quot;jdbc&quot;);
 * UserDAO userDAO = dbFactory.getUserDAO();
 * </pre>
 * 
 * Project :Shree Garments & Trading Inventory System Developed By:
 * techmomentous.com Visit: www.techmomentous.com Developer: Rizwan Ahmad Khan
 */
public abstract class DAOFactory {
	...
	public static DAOFactory getInstance(String name)
		...
		String url = properties.getProperty(Constants.PROPERTY_URL, true);
		String driverClassName = properties.getProperty(
				Constants.PROPERTY_DRIVER, false);
		String password = properties.getProperty(Constants.PROPERTY_PASSWORD,
				false);
		String username = properties.getProperty(Constants.PROPERTY_USERNAME,
				password != null);
		DAOFactory instance;
	...
	public AssignmentDB getAssignmentDB() {
		return new AssignmentDB(this);
	}

	public EventCatDB getEventCatDB() {
		return new EventCatDB(this);
	}

	public EventDB getEventDB() {
		return new EventDB(this);
	}

	public ExamDB getExamDB() {
		return new ExamDB(this);
	}

	public TimeTableDB getTimeTableDB() {
		return new TimeTableDB(this);
	}
